  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Replaced the legacy sqoop-based pipeline that shipped PostgreSQL tables to BigQuery. Moved it to Aurora FastClones orchestrated through Airflow: spin up a clone, read the data, ship it to BigQuery, tear the clone down. Production databases took none of the load.",
        "Built a custom Envoy control plane (go-control-plane + sidecar ECS containers) enabling Cloud Development Environments: engineers deploy only their changed services and get full isolation via routing labels. Labels are extracted from personal subdomain URLs (engineer.demo.thumbtack.com), injected as HTTP headers at the edge, and propagated through the service graph. Requests fall through to the shared baseline for untouched services. None of it needed duplicate infrastructure or changes to application code.",
    ...
    },
    {
      ...
      date: "2016 - 2018",
      bullets: [
        "Wrote a Chef bootstrapping script that deployed dockerized microservices into a VM at the edge, where cloud applications controlled them over MQTT.",
    ...
    },
    {
      ...
      bullets: [
        "Led development of a crowdsourced recommendation engine for local deals, where shoppers compared prices and read recommendations from real buyers before big-ticket purchases like TVs and other electronics.",
